...
| `MEDICATION_REVIEW_V1` | `CONVERGENCE_IN_PROGRESS` | Pharmacotherapeutic Review | `src/features/medication-review/MedicationReview.tsx` | Visual baseline v1 convergence 1:1 using adjusted Stitch reference. Interactive prescription table, hemodynamic mechanism block, contextual detail inspector, safety disclaimers, and scenario integration. |
